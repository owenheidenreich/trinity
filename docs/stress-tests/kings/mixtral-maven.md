...
|-------|-------|
| **Model** | mixtral:8x22b |
| **Provider ID** | king-mixtral |
| **GPU** | A100-80GB (4090 Provider) |
| **Memory** | 96Gi |
| **Base URL** | `https://bnivii01v9bcbchrqtej5pmd0k.ingress.4090.akashgpu.com` |
| **Health** | `/health` |
| **Generate** | `/generate` |
| **Metrics** | `/metrics` |
...
### Metrics
```bash
curl -s "https://bnivii01v9bcbchrqtej5pmd0k.ingress.4090.akashgpu.com/metrics"
```
