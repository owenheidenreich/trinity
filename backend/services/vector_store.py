...
from config import CHATS_DIR, EMBEDDING_DIM, RAG_TOP_K
...
class VectorStore:
    ...
    def add_message_embedding(self, chat_id: str, message_index: int, role: str,
    ...
    def search_messages(self, query_embedding: np.ndarray, chat_id: str = None,
                       k: int = 5, recency_weight: float = 0.3) -> List[Dict]:
        """
