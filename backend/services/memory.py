...
from config import WORKING_MEMORY_SIZE, SEMANTIC_MEMORY_SIZE, RECENCY_WEIGHT
...
class SemanticMemory:
    ...
    def retrieve_context(self, query: str, chat_id: str = None,
                        working_memory_size: int = WORKING_MEMORY_SIZE,
                        semantic_memory_size: int = SEMANTIC_MEMORY_SIZE) -> Dict:
        """
...
def build_enhanced_context(query: str, principal_id: str, chat_id: str = None,
                          context_messages: List[Dict] = None,
                          user_memory: Dict = None) -> str:
    """
