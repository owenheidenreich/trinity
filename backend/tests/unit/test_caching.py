...
class TestSemanticResponseCache:
    ...
    def test_cache_initialization(self):
        ...
        cache = SemanticResponseCache(max_size=100, similarity_threshold=0.9, ttl_seconds=60)
    ...
    def test_similar_query_retrieval(self):
        ...
        cache.put(
            query="original", query_embedding=original, response="cached response", model="test"
        )
...
class TestTokenUsage:
    ...
    def test_token_usage_creation(self):
        ...
        usage = TokenUsage(
            prompt_tokens=100, completion_tokens=50, total_tokens=150, model="llama3.1:8b"
        )
    ...
    def test_cost_estimation_small_model(self):
        ...
        usage = TokenUsage(
            prompt_tokens=1000, completion_tokens=500, total_tokens=1500, model="llama3.1:8b"
        )
    ...
    def test_cost_estimation_large_model(self):
        ...
        usage = TokenUsage(
            prompt_tokens=1000, completion_tokens=500, total_tokens=1500, model="qwen2.5:72b"
        )
