...
class TestTrinityLLM:
    ...
    def test_get_model_helpers(self):
        ...
        from services.graph.llm import get_fast_llm, get_smart_llm, get_reasoning_llm
...
class TestAgents:
    ...
    def test_import_agents(self):
        ...
        from services.graph.agents import (
            ...
            CodingAgent, SynthesisAgent, get_agent
        )
    ...
    def test_get_agent_factory(self):
        ...
        from services.graph.agents import get_agent, SupervisorAgent, ReasoningAgent
...
class TestNodes:
    ...
    def test_import_nodes(self):
        ...
        from services.graph.nodes import (
            router_node, research_node, reasoning_node,
            coding_node, synthesis_node
        )
