...
def mock_ollama(mock_ollama_response):
    ...
    with patch("requests.post") as mock_post:
        ...
        mock_response.iter_lines.return_value = [json.dumps(mock_ollama_response).encode()]
...
def sample_user_memory():
    ...
    return {
        ...
        "preferences": {"language": "Python", "verbosity": "detailed"},
    }
...
def assert_response_error():
    ...
    def _assert_error(response, expected_status, expected_error_contains=None):
        ...
        if expected_error_contains:
            ...
            assert (
                expected_error_contains.lower() in error_msg.lower()
