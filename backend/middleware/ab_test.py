...
try:
    from services.experiments import assign_variant, get_all_assignments
...
try:
    from middleware.observability import (
        ...
        EXPERIMENT_ASSIGNMENTS as experiment_assignments,
        EXPERIMENT_EXPOSURES as experiment_exposures
    )
except ImportError:
